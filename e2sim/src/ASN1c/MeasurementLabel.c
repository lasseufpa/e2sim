...
asn_TYPE_member_t asn_MBR_MeasurementLabel_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct MeasurementLabel, ssbIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ssbIndex_constr_39,  memb_ssbIndex_constraint_1 },
		0, 0, /* No default value */
		"ssbIndex"
		},
	{ ATF_POINTER, 2, offsetof(struct MeasurementLabel, nonGoB_BFmode_Index),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nonGoB_BFmode_Index_constr_40,  memb_nonGoB_BFmode_Index_constraint_1 },
		0, 0, /* No default value */
		"nonGoB-BFmode-Index"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasurementLabel, mIMO_mode_Index),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_mIMO_mode_Index_constr_41,  memb_mIMO_mode_Index_constraint_1 },
		0, 0, /* No default value */
		"mIMO-mode-Index"
		},
};
